...
PY = ["test_geo.py", "test_catalog.py", "test_network.py", "test_schedule.py", "test_cost.py",
      "test_ncs.py", "test_import.py", "test_map.py", "test_multiphase.py", "test_thermal.py", "test_bathymetry.py", "test_well.py", "test_costio.py", "test_cases.py", "test_report.py", "test_tiein.py", "test_basis.py",
